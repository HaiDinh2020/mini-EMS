...
public interface MetricSampleRepository extends MongoRepository<MetricSample, String> {
    ...
    Page<MetricSample> findByDeviceIdOrderByCollectedAtDesc(String deviceId, Pageable pageable);

    List<MetricSample> findByDeviceIdAndCollectedAtBetweenOrderByCollectedAtAsc(String deviceId, Instant from, Instant to);
}
