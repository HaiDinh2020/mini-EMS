...
import { TopologyLinkDeleteDialog } from './topology-link-delete-dialog';

describe('TopologyLink Management Delete Component', () => {
  let comp: TopologyLinkDeleteDialog;
  let fixture: ComponentFixture<TopologyLinkDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TopologyLinkDeleteDialog);
