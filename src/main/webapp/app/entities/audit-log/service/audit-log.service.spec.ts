...
describe('AuditLog Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a AuditLog', () => {
      ...
      service.create(auditLog).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a AuditLog', () => {
      ...
      service.update(auditLog).subscribe(resp => (expectedResult = resp));
    ...
    describe('compareAuditLog', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { id: 'ccc9ca42-f95c-4b2b-a00d-7c54df66be4c' };
        const entity2 = null;
      ...
      it('should return false if primaryKey differs', () => {
        const entity1 = { id: 'ccc9ca42-f95c-4b2b-a00d-7c54df66be4c' };
        const entity2 = { id: '3cd293e7-61a9-4351-9411-9576d8593849' };
      ...
      it('should return false if primaryKey matches', () => {
        const entity1 = { id: 'ccc9ca42-f95c-4b2b-a00d-7c54df66be4c' };
        const entity2 = { id: 'ccc9ca42-f95c-4b2b-a00d-7c54df66be4c' };
