...
import { AlertEventDeleteDialog } from './alert-event-delete-dialog';

describe('AlertEvent Management Delete Component', () => {
  let comp: AlertEventDeleteDialog;
  let fixture: ComponentFixture<AlertEventDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AlertEventDeleteDialog);
