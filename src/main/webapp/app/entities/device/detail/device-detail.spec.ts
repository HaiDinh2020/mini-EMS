...
describe('Device Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { device: () => of({ id: 'd5008764-aa30-42e8-a82f-8025612527af' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('should load device on init', async () => {
      ...
      const instance = await harness.navigateByUrl('/', DeviceDetail);

      // THEN
      expect(instance.device()).toEqual(expect.objectContaining({ id: 'd5008764-aa30-42e8-a82f-8025612527af' }));
    });
  });
