...
import { MetricSampleDeleteDialog } from './metric-sample-delete-dialog';

describe('MetricSample Management Delete Component', () => {
  let comp: MetricSampleDeleteDialog;
  let fixture: ComponentFixture<MetricSampleDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MetricSampleDeleteDialog);
